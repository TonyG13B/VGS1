...
import com.vgs.kvpoc.index.cache.CouchbaseNativeCacheManager;
...
/**
 * ====================================================================
 * VGS KV POC - Transaction Index Pattern: Cache Configuration
 * ====================================================================
 * 
 * WHAT THIS CLASS DOES:
 * This configuration class sets up the caching system for the transaction index pattern.
...
public class CacheConfig {
    ...
    public void customizeMetricsCommonTags(MeterRegistry registry) {
        ...
        registry.config().commonTags(
            "application", "vgs-transaction-index",
            "pattern", "TransactionIndex",
            "instance", instance
        );
    }
